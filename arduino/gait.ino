...
//***********************************************************************
// IK and Hexapod gait references: 여기 참조하라는 뜻
...
//***********************************************************************
// Includes 이 라이브러리를 가지고 있다고 보면 된다. servo.h 와 math.h는 아두이노
// 라이브러리다.
//***********************************************************************
...
const int COXA_LENGTH = 51;           //leg part lengths 다리 부분별 길이 선언
...
// https://www.youtube.com/watch?v=uBLkfMTZuXk wave gait 영상 찾아왔다
//***********************************************************************
void wave_gait()
{
  //read commanded values from controller
...
// https://www.youtube.com/watch?v=44sbvB6AMNA
//***********************************************************************
void ripple_gait()
{
  //read commanded values from controller
...
//***********************************************************************
// Tetrapod Gait
// https://www.sciencemag.org/news/2017/02/special-gait-helps-six-legged-robot-outpace-insects
